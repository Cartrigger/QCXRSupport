...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed_support_channels = new EmbedBuilder()
            ...
            .setDescription("Support is handled in <#1463773310222336054> and you can see the FAQ in <#1378035608605167636>.\nOn top of this, you can see common issues in <#1378034717793714186>\n\nFor more guided support which may take longer, you can make a ticket in <#946184706486054984>, and a support member will be with you when available.")
            .setColor("Green")
