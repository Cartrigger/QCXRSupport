...
module.exports = {
    ...
    async execute(interaction) {
        try {
            const response = await fetch('https://raw.githubusercontent.com/Cartrigger/QCXRSupport/refs/heads/main/assets/guides/crashplay.md');
            if (!response.ok) {
            ...
            const embed_guide = new EmbedBuilder()
                .setTitle("**My game crashes when I press play**")
                .setDescription(markdown)
                .setColor("Blue")
                .setFooter({
                    text: "Written by my Support Staff",
