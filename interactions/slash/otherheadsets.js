...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed_otherheadsets = new EmbedBuilder()
            ...
            .setDescription("QuestCraft is planned to release on other headsets in the future. \n Currently we are planned to release on **Pico** headsets in the future. From the recent past, we released and discontinued YVRCraft.")
            .setColor("Green")
