...
const embeds = {
  ...
  unity: new EmbedBuilder()
    ...
    .setDescription("The launcher is made in Unity, with Pojlib, which makes it where you can launch into VR mode, play the game, switch MC versions, and use ModManager.")
    .setColor("Green"),
  ...
  fixed: new EmbedBuilder()
    ...
    .setDescription("Ever since George Washington crossed the Delaware. Yes, its fixed.")
    .setColor("Green"),
