...
const renderers = require('./interactions/slash/misc/renderers');

const embeds = {
  adb: new EmbedBuilder()
    .setTitle("Uninstalling using ADB commands.")
    .setDescription("If you're unable to reinstall and need to perform a complete uninstall, use the command: ``adb uninstall com.qcxr.qcxr``. For advanced users, SideQuest allows running ADB commands, as shown in the image below.")
  ...
  list: new EmbedBuilder()
    .setTitle("List of Supported Mods")
    .setDescription("There is a list of supported mods that is available at https://docs.google.com/spreadsheets/d/12yUTO_HgAEyZFoETxmzqaxPZrOUF1ocaQjbi_u5U2jI/edit?usp=sharing. If you have a mod that works in QC, but is not featured on the list, use this form (https://forms.gle/ugYJhwzm514NHbp37) to submit it!\n Looking for how to install mods? Use /mods!")
    .setColor("Green")
    .setFooter({ text: 'Written by swaggio'},
  renderers: new EmbedBuilder()
    .setTitle("GL4ES, Vulkan, and Zink")
    .setDescription("GL4ES has moderate speed, with moderate mod compatibility. Complex mods like Distant Horizons and Immersive Portals may not work.\n Zink, while being primarily slow, has great mod compatibility. Complex mods like Distant Horizons and Immersive Portals will work.\n - Vulkan, while being very fast, has low mod compatibility. Complex mods like Distant Horizons and Immersive Portals will work.")
    .setColor("Green")
    .setFooter({ text: 'Written by swaggio, with the help of The Judge'}, 
  ...
  releases: new EmbedBuilder()
    ...
    .setDescription("Questcraft is distributed on [**Github**](https://github.com/QuestCraftPlusPlus/QuestCraft) and [**Sidequest**](https://sidequestvr.com/app/7150/questcraft)\n||(Do ``/installation`` for info on how to install Questcraft)||")
    .setColor("Green")
    .setFooter({ text: 'Written by TechyGiraffe999'}),
  ...
  fixed: new EmbedBuilder()
    ...
    .setDescription("Yes! Since 500 B.C!")
    .setColor("Green"),
  github: new EmbedBuilder()
    .setTitle("GitHub info:")
    .setDescription("The QuestCraft GitHub is at the link [here](https://github.com/questcraftplusplus), and any other GitHub is potentially dangerous and any APK should not be downloaded from it.")
    .setColor("Green"),
