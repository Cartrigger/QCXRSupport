...
const embeds = {
    ...
    .setFooter({ text: 'Written by TechyGiraffe999', iconURL: 'https://media.discordapp.net/attachments/1059913125308145716/1157685309602013304/TechyGiraffe_v.2.0_test_3.png?ex=6533dff6&is=65216af6&hm=be5f4f64e4ad466e05649b713160104712622e426f1797c92ff78f58337a55f1&=&width=576&height=576'}),
    ...
    immersivemc_1_19_2:  new EmbedBuilder()
    ...
    knowncompat: new EmbedBuilder()
      ...
      .setColor("DarkBlue")
      .setFooter({ text: 'Written by Cartri, contributed to by ungerground2', iconURL: ''}),
